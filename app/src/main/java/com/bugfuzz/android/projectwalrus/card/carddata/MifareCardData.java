...
public class MifareCardData extends ISO14443ACardData {
    ...
    public final List<HistoricalReadAttempt> readAttemptHistory;

    public MifareCardData() {
        sectors = new HashMap<>();
        maxSector = new SectorNumber(0);
        readAttemptHistory = new ArrayList<>();
    }

    public MifareCardData(short atqa, BigInteger uid, byte sak, byte[] ats,
            @Nullable SectorNumber maxSector) {
    ...
    public static class HistoricalReadAttempt implements Serializable {

        public final SectorNumber number;
        public final Key key;
        public final KeySlot keySlot;
        public final boolean success;

        public HistoricalReadAttempt(SectorNumber number, Key key, KeySlot keySlot,
                boolean success) {
            this.number = number;
            this.key = key;
